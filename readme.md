## cas: Ca Scripting language [![Build status](https://ci.appveyor.com/api/projects/status/vec4jvercblgrsxn?svg=true)](https://ci.appveyor.com/project/Tomash667/cas)
